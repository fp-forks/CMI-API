...
public class effect implements Cmd {
    HashMap<UUID, freezeTimer> freezeSched = null;
    ...
    @Override
    @CAnnotation(priority = 115, info = "Adds potion effect to player. use clear to remove all effects", args = "[playername/all] [effect/clear] (duration/infinite) (multiplier) (-s) (-visual)", multiTab = {
            "[playername],clear [potioneffect],freeze,clear 60,infinite 1" }, explanation = { "-visual will add visible bubbles and icon on top right corner", "Examples:",
                    ...
                    "/cmi effect all health_boost 60 1 - will boost hp by 1 for everyone online" }, regVar = { 1, 2, 3, 4, 5, 6 }, consoleVar = { 1, 2, 3, 4, 5, 6 }, others = true)
