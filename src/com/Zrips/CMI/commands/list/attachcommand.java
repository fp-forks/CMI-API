...
public class attachcommand implements Cmd {
    ...
    static Pattern limitedPattern = null;
    static Pattern safeLimitedPattern = null;
    static Pattern cooldownPattern = null;
    ...
    @Override
    @CAnnotation(priority = 125, info = "Attaches command to item", args = "[command/-clear]", multiTab = { "-clear,[attachedCommand]" }, explanation = {
            ...
            "[interactedPlayer] inserts name of player you interacted while holding item", "Global variables working in addition with [itemUses]" }, regVar = {
                    -666 }, consoleVar = { 666 }, alias = true, customAlias = { "!powertool" }, modules = { "attachedcommands" }, others = false)
