...
public class setwarp implements Cmd {
    ...
    @Override
    @CAnnotation(info = "Sets warp location", args = "[warpName] (reqPermission) (hand/head/head:[playerName]) (slot) (autoLore) (-g:[groupName]) (world;x;y;z;yaw;pitch) (-confirm)", explanation = {
