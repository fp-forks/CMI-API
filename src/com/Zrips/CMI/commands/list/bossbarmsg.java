...
public class bossbarmsg implements Cmd {
    ...
    @Override
    @CAnnotation(priority = 48, info = "Sends boss bar message to player", args = "[playerName/all] (-sec:[seconds])(-t:[timeToKeepFor]) (-n:nameOfBar) (-p:[maxValue/current]) (-c:[color]) (-s:[1,6,10,12,20]) (-cmd:\"command;;command2\") (-pcmd:\"command;;command2\") (-a:[ticks]) [message] (-cancel:nameOfBar)", tab = {
            "playername" }, explanation = { "PlaceHolderAPI is supported for progression and text it self",
                    ...
                    "https://www.zrips.net/cmi/commands/bossbarmsg-handling/" }, regVar = { -100, -1 }, consoleVar = { -100, -1 }, ignoreHelpPage = true, others = false)
