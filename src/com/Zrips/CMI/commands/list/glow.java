...
public class glow implements Cmd {
    ...
    @Override
    @CAnnotation(info = "Set players glow mode", args = "(playerName) [true/false/color/gui]", tab = { "colors%%playername", "colors%%true%%false%%gui" }, explanation = { "Example: /glow Zrips red",
