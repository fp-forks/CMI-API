...
public class silentChestListener implements Listener {
    private static HashMap<UUID, SilentChest> silentChest = null;
    public static HashMap<UUID, Boolean> toggledSilentChest = null;
    private CMI plugin = null;
    private static HashMap<UUID, Long> sleep = null;
